        ...
        if (order.getStatus().equals(Constant.OrderStatus.REFUNDS.name())) {
            ...
            changeStatusButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(OrderDetail.this, String.valueOf(order.getId()), Toast.LENGTH_SHORT).show();
                    Toast.makeText(OrderDetail.this, String.valueOf(statusNext), Toast.LENGTH_SHORT).show();
